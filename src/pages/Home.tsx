          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-8">
              ...
              <p className="mt-8 max-w-xl text-lg text-slate-light leading-relaxed">
                The shift from rigid copper hardware to reconfigurable polymers and graphene films
                is redefining how radio frequency systems are designed, deployed, and adapted.
              </p>
      ...
      <section className="bg-bone py-24 lg:py-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              ...
              <h2 className="font-serif text-4xl lg:text-5xl text-navy leading-tight">
                From stubborn metal to <em className="text-copper not-italic">smart</em> material.
              </h2>
            </div>
            <div className="lg:col-span-8 lg:pl-8 lg:border-l border-steel">
              <p className="text-xl text-navy leading-relaxed mb-6">
                For a century, antennas have been made of copper and gold — high-conductivity metals
                that excel at one job but cannot adapt. As 5G evolves into 6G, every device must
                negotiate a denser, more crowded spectrum.
              </p>
              <p className="text-lg text-slate leading-relaxed">
                This portfolio bridges peer-reviewed research with industrial application: conducting
                polymers that act as electrochemical switches, lightweight 3D-printed K-band horns,
                and graphene assembled films that solve thermal dissipation. Together they mark a
                turning point — where hardware becomes as flexible as the software it houses.
              </p>
            </div>
          </div>
          ...
          <div className="mt-20 grid md:grid-cols-3 gap-px bg-steel border border-steel">
            {[
              { icon: Atom, t: "Reconfigurable Polymers", d: "Conducting polymers like polyaniline switch frequency states through redox chemistry — no mechanical parts." },
              { icon: Layers, t: "Graphene Assembled Films", d: "Thermal conductivity that outperforms copper, plus built-in EMI shielding for sensitive RF stages." },
              { icon: Zap, t: "Industrial Implication", d: "Lighter aerospace payloads, fewer redundant antennas per phone, and adaptive hardware for global spectrum." },
            ].map(({ icon: Icon, t, d }) => (
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="font-serif text-3xl lg:text-4xl leading-snug">
              "This site exists to translate laboratory chemistry into engineering specification —
              and to position my work for the teams building the next generation of aerospace and
